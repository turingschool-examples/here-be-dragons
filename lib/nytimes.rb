  ...
  DATA = {
    ...
    :"results" => [
      ...
      },
      {
        ...
        :"org_facet" => [],
        :"per_facet" => ["Obama, Barack", "Trump, Donald J"],
        :"geo_facet" => [],
        :"multimedia" => [
          {
      ...
      },
      {
        ...
        :"per_facet" => ["Ocasio-Cortez, Alexandria", "Pressley, Ayanna", "Trump, Donald J"],
        :"geo_facet" => [],
        :"multimedia" => [
          {
      ...
      },
      {
        ...
        :"org_facet" => [],
        :"per_facet" => ["Maduro, Nicolas"],
        :"geo_facet" => ["Venezuela", "Latin America"],
        :"multimedia" => [
          {
      ...
      },
      {
        ...
        :"org_facet" => ["Kasowitz Benson Torres LLP"],
        :"per_facet" => ["Kavanaugh, Brett M"],
        :"geo_facet" => [],
        :"multimedia" => [
          {
      ...
      },
      {
        ...
        :"per_facet" => ["Lina Khan", "Bezos, Jeffrey P"],
        :"geo_facet" => [],
        :"multimedia" => [
          {
      ...
      },
      {
        ...
        :"material_type_facet" => "",
        :"kicker" => "",
        :"des_facet" => ["United States Open (Tennis)", "Tennis", "Coaches and Managers"],
        :"org_facet" => [],
        :"per_facet" => ["Williams, Serena", "Osaka, Naomi (1997- )", "Bajin, Sascha"],
        :"geo_facet" => [],
        :"multimedia" => [
          {
      ...
      },
      {
        ...
        :"material_type_facet" => "",
        :"kicker" => "",
        :"des_facet" => ["Diplomatic Service, Embassies and Consulates"],
        :"org_facet" => [],
        :"per_facet" => ["Cher (1946- )", "Woodward, Bob"],
        :"geo_facet" => ["Genoa (Italy)"],
        :"multimedia" => [
          {
      ...
      },
      {
        ...
        :"org_facet" => ["Poly Prep Country Day School"],
        :"per_facet" => [],
      ...
      },
      {
        ...
        :"material_type_facet" => "",
        :"kicker" => "",
        :"des_facet" => ["United States Politics and Government", "Appointments and Executive Changes"],
        :"org_facet" => ["Supreme Court (US)", "Senate Committee on the Judiciary"],
        :"per_facet" => ["Kavanaugh, Brett M"],
        :"geo_facet" => [],
        :"multimedia" => [
          {
      ...
      },
      {
        ...
        :"material_type_facet" => "",
        :"kicker" => "",
        :"des_facet" => ["Alzheimer's Disease", "Dementia", "Labor and Jobs"],
      ...
      },
      {
        ...
        :"org_facet" => [],
        :"per_facet" => ["Musk, Elon", "Trump, Donald J", "Jackson, Ronny L"],
        :"geo_facet" => [],
        :"multimedia" => [
          {
      ...
      },
      {
        ...
        :"material_type_facet" => "",
        :"kicker" => "",
        :"des_facet" => ["Surfacing 2018", "Women and Girls", "Music"],
        :"org_facet" => [],
        :"per_facet" => [],
        :"geo_facet" => ["Brazil"],
        :"multimedia" => [
      ...
      },
      {
        ...
        :"org_facet" => ["Muslim Brotherhood (Egypt)"],
        :"per_facet" => ["Abou Zeid, Mahmoud (1987- )"],
        :"geo_facet" => ["Egypt", "Rabaa al-Adawiya (Cario, Egypt)"],
        :"multimedia" => [
          {
      ...
      },
      {
        ...
        :"org_facet" => ["Justice Department", "Citizenship and Immigration Services (US)"],
        :"per_facet" => ["Sessions, Jefferson B III", "Trump, Donald J"],
      ...
      },
      {
        ...
        :"material_type_facet" => "",
        :"kicker" => "",
        :"des_facet" => ["Bridges and Tunnels", "Mario M. Cuomo Bridge"],
        :"org_facet" => ["New York State Thruway Authority"],
        :"per_facet" => ["Cuomo, Andrew M"],
        :"geo_facet" => ["Hudson River", "New York State", "Tappan Zee Bridge"],
        :"multimedia" => [
          {
      ...
      },
      {
        ...
        :"material_type_facet" => "",
        :"kicker" => "",
        :"des_facet" => ["Subways", "September 11 (2001)"],
        :"org_facet" => ["Metropolitan Transportation Authority"],
        :"per_facet" => ["Moss, Mitchell L"],
      ...
      },
      {
        ...
        :"org_facet" => ["Harvard University"],
        :"per_facet" => ["Summers, Lawrence H", "Katz, Lawrence F"],
        :"geo_facet" => [],
        :"multimedia" => [
          {
      ...
      },
      {
        ...
        :"org_facet" => ["Silk City (Music Group)"],
        :"per_facet" => [
      ...
      },
      {
        ...
        :"material_type_facet" => "",
        :"kicker" => "",
        :"des_facet" => ["Batteries", "Computers and the Internet"],
        :"org_facet" => [],
        :"per_facet" => [],
        :"geo_facet" => [],
        :"multimedia" => [
      ...
      },
      {
        ...
        :"material_type_facet" => "",
        :"kicker" => "",
        :"des_facet" => ["Alcoholic Beverages", "Research", "Medicine and Health"],
        :"org_facet" => [],
        :"per_facet" => [],
        :"geo_facet" => [],
        :"multimedia" => [
      ...
      },
      {
        ...
        :"org_facet" => ["Atlantic Theater Co", "Playwrights Horizons", "Public Theater"],
        :"per_facet" => [
          "Ali, Saheem",
          "Bonney, Jo",
          "Butterworth, Jez",
      ...
      },
      {
        ...
        :"material_type_facet" => "",
        :"kicker" => "",
        :"des_facet" => ["Cooking and Cookbooks", "Recipes"],
        :"org_facet" => [],
        :"per_facet" => [],
        :"geo_facet" => [],
        :"multimedia" => [
      ...
      },
      {
        ...
        :"material_type_facet" => "",
        :"kicker" => "",
        :"des_facet" => ["Amusement and Theme Parks", "Roller Coasters"],
        :"org_facet" => [],
        :"per_facet" => [],
        :"geo_facet" => ["Farmingdale (NY)"],
        :"multimedia" => [
          {
      ...
      },
      {
        ...
        :"org_facet" => ["University of Nottingham"],
        :"per_facet" => [],
        :"geo_facet" => ["Helsinki (Finland)"],
        :"multimedia" => [
          {
      ...
      },
      {
        ...
        :"material_type_facet" => "",
        :"kicker" => "",
        :"des_facet" => ["Sharks", "Flowers and Plants", "omnivores"],
        :"org_facet" => ["Proceedings of the Royal Society B (Journal)"],
        :"per_facet" => [],
        :"geo_facet" => ["Gulf of Mexico"],
        :"multimedia" => [
          {
